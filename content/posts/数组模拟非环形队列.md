---
title: 数组模拟非环形队列
date: 2019-09-29 21:16:49+08:00
updated: '2019-09-29T21:16:49+08:00'
description: 队列是一个有序列表，可以用数组或是链表来实现。 package com.leeyf.queue; import java.util.Scanner; public class ArrayQueueDemo { public
  static void main(String[] args) { Arra。
