---
title: 算法小练——不同的二叉搜索树
date: 2020-01-12 21:39:51+08:00
updated: '2020-01-12T21:39:51+08:00'
description: '给定一个整数 n，求以 1 … n 为节点组成的二叉搜索树有多少种？ 给定 n = 3, 一共有 5 种不同结构的二叉搜索树: class Solution { public int numTrees(int n)
  { int[] G = new int[n+1]; for (int i = 2。'
