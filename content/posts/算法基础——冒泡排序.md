---
title: 算法基础——冒泡排序
date: 2019-11-29 16:16:29+08:00
updated: '2019-11-29T16:16:29+08:00'
description: 通过重复的走访要排序的元素列，依次比较相邻的每个元素，如果顺序错误就交换。 / 1. 从当前元素起，向后依次比较每一对相邻元素，若逆序则交换 / / 2. 对所有元素均重复以上步骤，直至最后一个元素 / public
  static void bubbleSort(int [] arr){ for(i。
